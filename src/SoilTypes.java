...
public class SoilTypes {
    ...
    public static final SoilType ARGILE = new SoilType("ARGILE",0.001,0.2,new Color(94, 81, 55,250),0.3);
    public static final SoilType ROCHE_GRES = new SoilType("ROCHE_GRES",0.002,0.01,new Color(124, 120, 120,250),0);
    public static final SoilType ROCHE_CALCAIRE = new SoilType("ROCHE_CALCAIRE",0.008,0.8,new Color(191, 191, 191,250),0.3);
